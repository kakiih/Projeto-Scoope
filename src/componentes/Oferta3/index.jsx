...
const CuritibaPage = () => {
  const Curitiba = {
    nome: 'Curitiba',
    imagem: 'https://images.pexels.com/photos/28412016/pexels-photo-28412016/free-photo-of-parque-barigui-curitiba-parana-brasil.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
